...
public class RolDAO {
    ...
    public List<Rol> listar() {
        List<Rol> registros = new ArrayList();
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "RolDAO::listar->" + e.getMessage());
            } finally {
                ps = null;
                rs = null;
                CON.desconectar();
    ...
    public List<Rol> seleccionar() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "RolDAO::seleccionar->" + e.getMessage());
        } finally {
            ps = null;
            rs = null;
            CON.desconectar();
    ...
    public int total() {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                totalRegistros = rs.getInt("COUTN(id)");
            }
            ps.close();
            rs.close();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "RolDAO::totalr->" + e.getMessage());
        } finally {
            ps = null;
            rs = null;
            CON.desconectar();
